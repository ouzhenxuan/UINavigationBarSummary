...
+ (void)initialize
{
    ...
    [navBar setBackgroundImage:[UIImage imageNamed:navBarBg] forBarMetrics:UIBarMetricsDefault];//forBarMetrics:UIBarMetricsDefault设置样式.
    navBar.translucent = YES;//设置是否透明.
    // 3.标题
#ifdef __IPHONE_7_0
...
{
    return UIStatusBarStyleLightContent;//设置状态栏的样式(颜色,...)
}
@end
